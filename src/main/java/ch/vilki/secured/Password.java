...
public class Password {
    ...
    public static String hash(SecureString password, byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public static SecureString decrypt(String strEncrypted,SecureString strKey) {
        String strData="";
