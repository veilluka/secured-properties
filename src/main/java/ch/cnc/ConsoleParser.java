...
public class ConsoleParser {
    ...
    public static void initParser()
    {
        ...
        Option checkPassword = new Option("checkPassword",true,"check master password ");
        checkPassword.setArgName("FILENAME");
        checkPassword.setOptionalArg(true);
        ...
        _options.addOption(checkPassword);
    }
