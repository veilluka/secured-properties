...
public class MainWindowController {
    ...
    private void initialize() {
       ...
       _clipboard.setOnAction(x->{
        ...
        _buttonOpenFile.setGraphic(new ImageView(new Image(MainWindowController.class.getResourceAsStream("/icons/editFile.png"))));
        _buttonCreateFile.setGraphic(new ImageView(new Image(MainWindowController.class.getResourceAsStream("/icons/addFile.png"))));
        _buttonAddProperty.setGraphic(new ImageView(new Image(MainWindowController.class.getResourceAsStream("/icons/addProperty.png"))));
        _buttonImportCSV.setGraphic(new ImageView(new Image(MainWindowController.class.getResourceAsStream("/icons/importFromCSV.png"))));
        _buttonOpenFile.setOnAction(x->openFile());
        _buttonCreateFile.setOnAction(x->createFile());
